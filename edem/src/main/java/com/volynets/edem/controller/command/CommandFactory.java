...
import com.volynets.edem.controller.command.impl.admin.AddAnimalCommand;
...
import com.volynets.edem.controller.command.impl.admin.VisitAddAnimalCommand;
...
public class CommandFactory {
	...
	private CommandFactory() {
		...
		commandMap.put(CommandType.VISIT_ADD_ANIMAL, new VisitAddAnimalCommand());
		commandMap.put(CommandType.ADD_ACTION, new AddActionCommand());
		commandMap.put(CommandType.ADD_ANIMAL, new AddAnimalCommand());
