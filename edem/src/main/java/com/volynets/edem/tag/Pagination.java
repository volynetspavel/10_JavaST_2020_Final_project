...
public final class Pagination {
	 ...
	 * Use new Pagination.Builder() to build Pagination instance
	 */
	private Pagination(String previousUrl, String nextUrl, List<PageItem> pages, String command) {
		super();
	...
	public static class Builder {
		...
		public Builder(String baseUrl, int offset, int count, String command) {
			super();
		...
		public Pagination build() {
			...
			return new Pagination(previousUrl, nextUrl, pages, command);
		}
	}
}
