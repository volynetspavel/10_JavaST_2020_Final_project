...
/**
 * TestPooledConnection is used to give the object special behavior.
 * 
 * @author Pavel Volynets
 * @version 1.0
 */
public class TestPooledConnection implements Connection {
	 ...
	 */
	TestPooledConnection(Connection connection) {
