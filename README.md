...
В приложении представлен список различных "действий" (привычек), которые несут положительный эффект на окружающую среду и помогают сохранить различных животных.
    ...
    Иллюстрирование идеи приложения на основе примера: 
...
Администратор:
- может добавлять, удалять и обновлять список действий (привычек), животных и пользователей;

Пользователь:
- регистрация;
- выбор "действия" (привычки) и добавлние в свой список;
- просмор всех "действий" и всех животных;
